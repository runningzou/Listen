...
public class CharacterDrawable extends Drawable {
    ...
    public static CharacterDrawable generateAlbumDrawable(Context context, String albumName) {
        ...
        return new CharacterDrawable.Builder()
                ...
                .setBackgroundColor(ContextCompat.getColor(context, R.color.listen_characterView_background))
                .setCharacterTextColor(ContextCompat.getColor(context, R.color.listen_characterView_textColor))
                .setCharacterPadding(context.getResources().getDimensionPixelSize(R.dimen.listen_characterView_padding))
                .build();
    }
}
